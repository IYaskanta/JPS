...
if (isset($_POST['submit']) != "") {
    ...
    $date = $_POST['date'];
    $insert = mysqli_query($db, "Insert into announcement(name,content,date)values('$name','$content','$date')");
    echo $insert;
    if ($insert) {
    ...
    <div class="navbar navbar-default header-highlight">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <div class="navbar-right">
                <p class="navbar-text"><span class="label bg-success"><b><?php date_default_timezone_set('Asia/Calcutta');
                                                                            echo date('Y-m-d h-i-s'); ?></b></span></p>
                <ul class="nav navbar-nav">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                                    ...
                                    <fieldset>
                                        ...
                                        <form enctype="multipart/form-data" action="" name="form" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea  name="content" class="form-control" placeholder="Enter the content" ></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Enter Date:</label>
                                                <input type="date" name="date" class="form-control" placeholder="Enter date of Event">
                                            </div>
                                            <input type="hidden" name="created_at" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                                    </fieldset>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">All Announcement</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
                                    <li><a data-action="collapse"></a></li>
                                    <li><a data-action="reload"></a></li>
                        ...
                        <table class="table datatable-basic table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <?php
                                    $count = 1;
                                    $select = mysqli_query($db, "select * from announcement order by id desc");
                                    ...
                                    ?>
                                        ...
                                        <td><?php echo $content; ?></a></td>
                                        <td><?php echo $date; ?></td>
                                        <td><a href="edit-announcement.php?id=<?php echo $row1['id']; ?>" onclick="return confirm('You Are Going to Update Record!!')"><span class="label label-success">Edit</span></a></td>
                                        <!--<td><a href="room.php?id=<?php echo $row1['id']; ?>" ><i class="icon-trash"></i> Delete</a></td>-->
                                        <td><a href="#" data-id="<?php echo $row1['id'] ?>" id="delete" class="btn btn-danger btn-xs">Delete</a></td>
                                        <td>#</td>
    ...
    <script>
        $(document).on('click', '#delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    type: "POST",
                    url: "ajax_delete_announcement.php",
                    data: info,
                    success: function() {}
                });
