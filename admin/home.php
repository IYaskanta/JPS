			...
			<div class="content-wrapper">
				...
				<div class="content">
                       <!-- Quick stats boxes -->
							<div class="row">
								<div class="col-lg-4">
									...
									<div class="panel bg-teal-400">
										<a href="users_maintenance.php"><div class="panel-body">
											<div class="heading-elements">
												
											</div>

											<h3 class="no-margin" style="color:white;">MAINTENANCE/FOOD DOCS</h3>
											
											<div class="text-muted text-size-small">CSC</div>
										</div></a>
								...
								<div class="col-lg-4">
									...
									<div class="panel bg-pink-400">
										<a href="users_hr.php"><div class="panel-body">
											<div class="heading-elements">
												
											</div>

											<h3 class="no-margin" style="color:white;">HR/COMPANY POLICY DOCS </h3>
								...
								<div class="col-lg-4">
									...
									<div class="panel bg-blue-400">
										<a href="users_it.php"><div class="panel-body">
											<div class="heading-elements">
											
						                	</div>

											<h3 class="no-margin" style="color:white;">IT DOCS</h3>
							...
							<div class="row">
								<div class="col-lg-4">
									...
									<!-- Members online -->
									<div class="panel bg-teal-400">
									<a href="users_accounts.php">	<div class="panel-body">
											<div class="heading-elements">
												
											</div>

											<h3 class="no-margin" style="color:white;">FINANCE DOCS</h3>
					...
					<!--<div class="footer text-muted" style="color:black;">
					          Copyright © <?php echo date("Y"); ?> Powered by JCH.
					</div>
					<!-- /footer -->
