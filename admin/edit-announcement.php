...
if (isset($_POST['update']) != "") {
    ...
    $update = mysqli_query($db, "update announcement set name='$name', content='$content' where id ='$id'");
    if ($update) {
...
if (isset($_GET['id'])) {
    ...
    $result = mysqli_query($db, "SELECT * FROM announcement where id='$id' ");
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Edit Announcement</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
                                        ...
                                        <fieldset>
                                            ...
                                            <form enctype="multipart/form-data" action="" name="form" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="content" value="<?php echo $content; ?>" class="form-control" placeholder="Enter your Content">
                                                </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
