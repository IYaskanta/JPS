...
//$conn=mysqli_connect("localhost","campusvi_share","hL&RbigFG31v") or die(mysql_error());
...
$update=mysqli_query($db,"update upload set name='$name', file_name='$file_name' where id ='$id'") ;
if($update){
...
$result= mysqli_query($db,"SELECT * FROM upload where id='$id' ");
							...
							<div class="panel-body">
                               ...
                               <form enctype="multipart/form-data" action="" name="form" method="post">
											<div class="form-group">
												...
												<input type="text" name="file_name" value="<?echo $file_name;?>" class="form-control" placeholder="Eugene Kopyov">
											</div>
											
											<div class="form-group">
												<label class="display-block">Attach Documents:</label>
											<td style="position: relative;right: -120px;padding-bottom: 25px;"><img  src="tick.png" width="14" height="14"><?php echo $name ;?></td>
								...
								<div class="text-right">
									<button type="submit" name="update" id="submit" value="Update" class="btn btn-primary">Submit form <i class="icon-arrow-right14 position-right"></i></button>
