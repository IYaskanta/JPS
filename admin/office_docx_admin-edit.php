...
$update=mysqli_query($db,"update office set name='$name', file_name='$file_name' where id ='$id'") ;
if($update){
...
$result= mysqli_query($db,"SELECT * FROM office where id='$id' ");
					...
					<!-- 2 columns form -->
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Office Doc</h5>
								<div class="heading-elements">
									<ul class="icons-list">
							...
							<div class="panel-body">
                               ...
                               <form enctype="multipart/form-data" action="" name="form" method="post">
											<div class="form-group">
												...
												<input type="text" name="file_name" value="<?echo $file_name;?>" class="form-control" placeholder="Enter your file name">
											</div>
