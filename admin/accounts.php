...
$insert=mysqli_query($db,"insert into accounts(name,file_name,date)values('$name','$file_name','$date')");
if($insert){
					...
					<!-- 2 columns form -->
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Accounts Departments</h5>
							...
							<!--<div class="panel-body">
                               ...
                               <form enctype="multipart/form-data" action="" name="form" method="post">
											<div class="form-group">
												...
												<input type="text" name="file_name" required class="form-control" placeholder="Enter your file name">
											</div>
					...
					<!--	<div class="panel-body">
						...
						<table class="table datatable-basic table-bordered table-striped table-hover">
							...
							<tbody>
								<tr>
								<?php
$select=mysqli_query($db,"select * from accounts order by id desc");
