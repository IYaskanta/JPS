...
$insert=mysqli_query($db,"insert into admin(name,file_name,date)values('$name','$file_name','$date')");
if($insert){
					...
					<!-- 2 columns form -->
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Admin Dept </h5>
							...
							<!--<div class="panel-body">
                               ...
                               <form enctype="multipart/form-data" action="" name="form" method="post">
											<div class="form-group">
												...
												<input type="text" name="file_name" class="form-control" placeholder="Enter your file name" required>
											</div>
								...
								<div class="text-right">
									<button type="submit" name="submit" id="submit" value="Submit" class="btn btn-primary">Submit form <i class="icon-arrow-right14 position-right"></i></button>
					...
					<!--	<div class="panel-body">
						...
						<table class="table datatable-basic table-bordered table-striped table-hover">
							...
							<tbody>
								<tr>
								<?php
$select=mysqli_query($db,"select * from it order by id desc");
