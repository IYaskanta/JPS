...
<!-- Bootstrap maxlength -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">All Contact Info</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<!--	<div class="panel-body">
						...
						<table class="table datatable-basic table-bordered table-striped table-hover">
							...
							<tbody>
								<tr>
							<?php
$select=mysqli_query($db,"select * from users order by id desc");
...
?>                                   	<td><a href="#"><?php echo $count++;?></a></td>
									...
									<td><img src="tick.png" width="14" height="14">&nbsp;&nbsp;<a href="<?php echo $mobile;?>" target=_blank><?php echo $mobile ;?></a></td>
									<td><a href="#"><?php echo $email;?></a></td>
									<td><?php echo $message;?></td>
										<td><?php echo $created;?></td>
									<!--<td><a href="edit_events.php?id=<?php echo $row1['id'];?>" onclick="return confirm('You Are Going to Update Record!!')"><span class="label label-success">Edit</span></a></td>-->
   ...
   echo "<div style='text-align: center;font-weight:bold;left: -55px;color:red;'><h3>You dont have privilege to access this page</h3></div>";
	...
	<!-- /page container -->
<script> $(document).on('click','#delete',function(){ var element = $(this); var del_id = element.attr("data-id"); var info = 'id=' + del_id; if(confirm("Are you sure you want to delete this?")) { $.ajax({ type: "POST", url: "ajax_delete_events.php", data: info, success: function(){  } }); $(this).parents("tr").animate({ backgroundColor: "#003" }, "slow") .animate({ opacity: "hide" }, "slow"); } return false; }); </script>
